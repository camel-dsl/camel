...
public class LocationSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case LocationPackage.LOCATION_MODEL: {
				LocationModel locationModel = (LocationModel)theEObject;
				T result = caseLocationModel(locationModel);
				if (result == null) result = caseModel(locationModel);
			...
			case LocationPackage.CLOUD_LOCATION: {
				CloudLocation cloudLocation = (CloudLocation)theEObject;
				T result = caseCloudLocation(cloudLocation);
				if (result == null) result = caseLocation(cloudLocation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case LocationPackage.GEOGRAPHICAL_REGION: {
				...
				if (result == null) result = caseLocation(geographicalRegion);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case LocationPackage.COUNTRY: {
				...
				if (result == null) result = caseGeographicalRegion(country);
	 ...
	 * @generated
	 */
	public T caseLocationModel(LocationModel object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Cloud Location</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Cloud Location</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseCloudLocation(CloudLocation object) {
		return null;
	}
