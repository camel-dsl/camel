 ...
 * <!-- end-user-doc -->
 * @see eu.paasage.camel.requirement.RequirementPackage#getRequirementOperatorType()
 * @model
 * @generated
 */
public enum RequirementOperatorType implements Enumerator {
	 ...
	 * @generated
	 */
	private static final RequirementOperatorType[] VALUES_ARRAY =
		new RequirementOperatorType[] {
			AND,
			OR,
			XOR,
		};
	 ...
	 * @generated
	 */
	public static RequirementOperatorType get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			RequirementOperatorType result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	public static RequirementOperatorType getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			RequirementOperatorType result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	public static RequirementOperatorType get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private RequirementOperatorType(int value, String name, String literal) {
		this.value = value;
		this.name = name;
