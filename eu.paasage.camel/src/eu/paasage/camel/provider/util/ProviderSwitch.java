...
public class ProviderSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ProviderPackage.PROVIDER_MODEL: {
				ProviderModel providerModel = (ProviderModel)theEObject;
				T result = caseProviderModel(providerModel);
				if (result == null) result = caseModel(providerModel);
			...
			case ProviderPackage.EXCLUDES: {
				...
				if (result == null) result = caseConstraint(excludes);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case ProviderPackage.REQUIRES: {
				...
				if (result == null) result = caseConstraint(requires);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ProviderPackage.FUNCTIONAL: {
				...
				if (result == null) result = caseRequires(functional);
				if (result == null) result = caseConstraint(functional);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case ProviderPackage.INSTANCE: {
				...
				if (result == null) result = caseScope(instance);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ProviderPackage.PRODUCT: {
				...
				if (result == null) result = caseScope(product);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseProviderModel(ProviderModel object) {
		return null;
	}
