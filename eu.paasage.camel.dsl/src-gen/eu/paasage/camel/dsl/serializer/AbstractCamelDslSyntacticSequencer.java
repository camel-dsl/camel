...
public abstract class AbstractCamelDslSyntacticSequencer extends AbstractSyntacticSequencer {
	 ...
	 *     to=[Feature|Fqn] (ambiguity) '}' (rule end)
	 */
	 ...
	 *
	 * This ambiguous syntax occurs at:
	 *     name=ID '{' (ambiguity) 'sub-features ' '{' subFeatures+=Feature
	 *     name=ID '{' (ambiguity) ('sub-features ' '{' '}')? featureCardinality=FeatCardinality
	 */
	 ...
	 *
	 * This ambiguous syntax occurs at:
	 *     attributes+=Attribute '}' (ambiguity) featureCardinality=FeatCardinality
	 *     name=ID '{' ('attributes ' '{' '}')? (ambiguity) featureCardinality=FeatCardinality
	 */
	 ...
	 *
	 * This ambiguous syntax occurs at:
	 *     portNumber=INT (ambiguity) 'port: ' portNumber=INT
	 *     portNumber=INT (ambiguity) '}' (rule end)
	 */
	 ...
	 *
	 * This ambiguous syntax occurs at:
	 *     name=ID '{' (ambiguity) 'root ' rootFeature=Feature
	 */
	 ...
	 *
	 * This ambiguous syntax occurs at:
	 *     isMandatory?='mandatory' (ambiguity) 'port: ' portNumber=INT
	 *     isMandatory?='mandatory' (ambiguity) '}' (rule end)
	 *     isMandatory?='mandatory' (ambiguity) isMandatory?='mandatory'
	 *     portNumber=INT (ambiguity) 'port: ' portNumber=INT
	 *     portNumber=INT (ambiguity) '}' (rule end)
	 *     portNumber=INT (ambiguity) isMandatory?='mandatory'
	 */
